    ...
    public class RockGeneratorEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!rockGen.isActiveAndEnabled)
                EditorGUILayout.HelpBox("Please enable rock generator's game object before editing!",
                    MessageType.Warning);
        ...
        private void Bake(string path)
        {
            ...
            var parameters = new BakeParameters
            {
                addCollider = addCollider, crop = crop, path = path, mergeVerticesThreshold = 0.1f,
                generateSecondaryUVSet = true, optimize = optimize
            };
